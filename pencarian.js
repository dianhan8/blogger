const Pencarian = () => {
  ...
  async function getPostByKeyword(query) {
    const url =
      "https://www.googleapis.com/blogger/v3/blogs/839057407940192023/posts/search?key=AIzaSyCiiU5S07er5yz_b6rQTXTVvCkqE46zYHY&q=";
    setIsLoading(true);
  ...
  return (
    <div>
      <button
        ...
        className="w-full px-4 py-2 flex items-center shadow-md rounded-md ring-1 ring-slate-900/10 focus:ring-2 focus:ring-blue-500"
      >
